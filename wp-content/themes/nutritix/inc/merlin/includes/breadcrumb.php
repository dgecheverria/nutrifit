...
class Nutritix_breadcrumb {
	...
	private function __construct() {
		...
		add_filter('nutritix_page_title', [$this, 'hide_title']);
	...
	public function breadcrumb_register() {
		$labels = [
			'name'               => esc_html__('Breadcrumbs', 'nutritix'),
			'singular_name'      => esc_html__('Breadcrumb', 'nutritix'),
			'menu_name'          => esc_html__('Breadcrumbs', 'nutritix'),
			'name_admin_bar'     => esc_html__('Breadcrumb', 'nutritix'),
			'add_new'            => esc_html__('Add New', 'nutritix'),
			'add_new_item'       => esc_html__('Add New Breadcrumb', 'nutritix'),
			'new_item'           => esc_html__('New Header Footer & Blocks Template', 'nutritix'),
			'edit_item'          => esc_html__('Edit Header Footer & Blocks Template', 'nutritix'),
			'view_item'          => esc_html__('View Header Footer & Blocks Template', 'nutritix'),
			'all_items'          => esc_html__('All Breadcrumb', 'nutritix'),
			'search_items'       => esc_html__('Search Header Footer & Blocks Templates', 'nutritix'),
			'parent_item_colon'  => esc_html__('Parent Header Footer & Blocks Templates:', 'nutritix'),
			'not_found'          => esc_html__('No Header Footer & Blocks Templates found.', 'nutritix'),
			'not_found_in_trash' => esc_html__('No Header Footer & Blocks Templates found in Trash.', 'nutritix'),
		];
		...
		register_post_type('nutritix-breadcrumb', $args);
	}
	...
	public function register_admin_menu() {
		add_submenu_page(
			'themes.php',
			esc_html__('Breadcrumbs', 'nutritix'),
			esc_html__('Breadcrumbs', 'nutritix'),
			'edit_pages',
			'edit.php?post_type=nutritix-breadcrumb'
		);
	}
	...
	function ehf_register_metabox() {
		add_meta_box(
			'ehf-meta-box',
			esc_html__('Breadcrumb Options', 'nutritix'),
			[
				$this,
				'efh_metabox_render',
			],
		...
		<table class="hfe-options-table widefat">
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('Display On', 'nutritix'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help"
					   title="<?php echo esc_attr__('Add locations for where this template should appear.', 'nutritix'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					...
					HFE\Lib\Astra_Target_Rules_Fields::target_rule_settings_field(
						...
						[
							'title'          => esc_html__('Display Rules', 'nutritix'),
							'value'          => '[{"type":"basic-global","specific":null}]',
							'tags'           => 'site,enable,target,pages',
							'rule_type'      => 'display',
							'add_rule_label' => esc_html__('Add Display Rule', 'nutritix'),
						],
						$include_locations
					);
					?>
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('Do Not Display On', 'nutritix'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help"
					   title="<?php echo esc_attr__('Add locations for where this template should not appear.', 'nutritix'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					<?php
					HFE\Lib\Astra_Target_Rules_Fields::target_rule_settings_field(
						...
						[
							'title'          => esc_html__('Exclude On', 'nutritix'),
							'value'          => '[]',
							'tags'           => 'site,enable,target,pages',
							'add_rule_label' => esc_html__('Add Exclusion Rule', 'nutritix'),
							'rule_type'      => 'exclude',
						],
						$exclude_locations
					);
			...
			<tr class="bsf-target-rules-row hfe-options-row">
				<td class="bsf-target-rules-row-heading hfe-options-row-heading">
					<label><?php esc_html_e('User Roles', 'nutritix'); ?></label>
					<i class="bsf-target-rules-heading-help dashicons dashicons-editor-help" title="<?php echo esc_attr__('Display custom template based on user role.', 'nutritix'); ?>"></i>
				</td>
				<td class="bsf-target-rules-row-content hfe-options-row-content">
					<?php
					HFE\Lib\Astra_Target_Rules_Fields::target_user_role_settings_field(
						...
						[
							'title'          => esc_html__('Users', 'nutritix'),
							'value'          => '[]',
							'tags'           => 'site,enable,target,pages',
							'add_rule_label' => esc_html__('Add User Rule', 'nutritix'),
						],
						$users
					);
					?>
	...
	public static function get_template_id() {
		...
		$hfe_templates = Astra_Target_Rules_Fields::get_instance()->get_posts_by_conditions('nutritix-breadcrumb', $option);
	...
	public function block_template_frontend() {
		if (is_singular('nutritix-breadcrumb') && !current_user_can('edit_posts')) {
	...
	function load_canvas_template($single_template) {
		...
		if ('nutritix-breadcrumb' == $post->post_type) {
