...
class Nutritix_WP_Widget_Recent_Posts extends WP_Widget_Recent_Posts {
	public function widget( $args, $instance ) {
		if ( ! isset( $args['widget_id'] ) ) {
			$args['widget_id'] = $this->id;
		}

		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : esc_html__( 'Recent Posts', 'nutritix' );
		...
		<ul>
			<?php foreach ( $r->posts as $recent_post ) : ?>
				...
				$title        = ( ! empty( $post_title ) ) ? $post_title : esc_html__( '(no title)', 'nutritix' );
				?>
				<li>
