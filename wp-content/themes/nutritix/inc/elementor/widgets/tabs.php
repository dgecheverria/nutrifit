 ...
 * @since 1.0.0
 */
class Nutritix_Elementor_Tabs extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('nutritix Tabs', 'nutritix');
    }
    ...
    public function get_script_depends() {
        return ['nutritix-elementor-tabs'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Tab Title', 'nutritix'),
                'placeholder' => esc_html__('Tab Title', 'nutritix'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control(
            'tab_number',
            [
                'label'       => esc_html__('Number', 'nutritix'),
                'type'        => Controls_Manager::TEXT,
            ]
        );
        ...
        $repeater->add_control(
            'source',
            [
                'label'   => esc_html__('Source', 'nutritix'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'html',
                'options' => [
                    'html'     => esc_html__('HTML', 'nutritix'),
                    'template' => esc_html__('Template', 'nutritix')
                ]
            ]
        );
        ...
        $repeater->add_control(
            'tab_template',
            [
                'label'       => esc_html__('Choose Template', 'nutritix'),
                'default'     => 0,
                'type'        => Controls_Manager::SELECT,
                'options'     => $options,
                'types'       => $types,
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Tab Content', 'nutritix'),
                'placeholder' => esc_html__('Tab Content', 'nutritix'),
        ...
        $this->add_control(
            'tabs',
            [
                'label'       => esc_html__('Tabs Items', 'nutritix'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'tab_title'   => esc_html__('Tab #1', 'nutritix'),
                        'tab_content' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'nutritix'),
                    ],
                    [
                        'tab_title'   => esc_html__('Tab #2', 'nutritix'),
                        'tab_content' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'nutritix'),
                    ],
                ],
        ...
        $this->add_control(
            'view',
            [
                'label'   => esc_html__('View', 'nutritix'),
        ...
        $this->add_control(
            'tab_button_number',
            [
                'label' => esc_html__('Button Number', 'nutritix'),
                'type' => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-nutritix-tabs.elementor-widget-tabs .elementor-tab-title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-nutritix-tabs.elementor-widget-tabs .elementor-tab-title' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-nutritix-tabs.elementor-widget-tabs .elementor-tab-title.elementor-active' => 'color: {{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}}.elementor-widget-nutritix-tabs.elementor-widget-tabs .elementor-tab-title.elementor-active' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'divider_height',
            [
                'label' => esc_html__('Divider Height', 'nutritix'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'hide_search',
            [
                'label'        => esc_html__('Sub Divider', 'nutritix'),
                'type'         => Controls_Manager::SWITCHER,
                'prefix_class' => 'sub-divider-tab-nutritix-',
            ]
        );
        ...
        $this->add_responsive_control('tab_title_padding',
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}}.elementor-widget-nutritix-tabs.elementor-widget-tabs .elementor-tab-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
        ...
        $this->add_responsive_control('tab_title_margin',
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}}.elementor-widget-nutritix-tabs.elementor-widget-tabs .elementor-tab-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name'      => 'tab_border',
                'selector'  => '{{WRAPPER}}.elementor-widget-nutritix-tabs.elementor-widget-tabs.elementor-tabs-view-horizontal .elementor-tab-title',
            ]
        );
        ...
        <div class="elementor-tabs" role="tablist">
            <div class="elementor-tabs-wrapper">
                ...
                foreach ($tabs as $index => $item) :
                    ...
                    ?>
                    <div <?php echo nutritix_elementor_get_render_attribute_string($tab_title_setting_key, $this); ?>>
                ...
                if ($setting['tab_button_text'] != '') {
                    $button_html = '<span class="text">' . $setting['tab_button_text'] . '</span><span class="number">'. $setting['tab_button_number'] .'</span><i class="nutritix-icon-right-arrow"></i>';
                ...
                foreach ($tabs as $index => $item) :
                    ...
                    <div <?php echo nutritix_elementor_get_render_attribute_string($tab_content_setting_key, $this); // WPCS: XSS ok.?>>
                        <?php if ('html' === $item['source']): ?>
                            <?php echo nutritix_elementor_parse_text_editor($item['tab_content'], $this); // WPCS: XSS ok. ?>
                        <?php else: ?>
...
$widgets_manager->register(new Nutritix_Elementor_Tabs());
