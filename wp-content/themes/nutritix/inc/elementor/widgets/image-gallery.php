 ...
 * @since 1.0.0
 */
class Nutritix_Elementor_Image_Gallery extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Nutritix Image Gallery', 'nutritix');
    }

    public function get_script_depends() {
        return [
            'isotope',
            'nutritix-elementor-image-gallery'
        ];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_gallery',
            [
                'label' => esc_html__('Image Gallery', 'nutritix'),
            ]
        );
        ...
        $repeater->add_control(
            'filter_title',
            [
                'label'       => esc_html__('Filter Title', 'nutritix'),
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => esc_html__('List Item', 'nutritix'),
                'default'     => esc_html__('List Item', 'nutritix'),
            ]
        );
        ...
        $repeater->add_control(
            'wp_gallery',
            [
                'label'      => esc_html__('Add Images', 'nutritix'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'filter_title' => esc_html__('Gallery 1', 'nutritix'),
                    ],
                ],
        ...
        $this->add_control(
            'show_filter_bar',
            [
                'label'     => esc_html__('Filter Bar', 'nutritix'),
        ...
        $this->add_responsive_control(
            'filter_item_spacing',
            [
                'label'     => esc_html__('Space Between', 'nutritix'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'filter_padding',
            [
                'label'      => esc_html__('Filter Padding', 'nutritix'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range'      => [
                    'px' => [
        ...
        $this->add_responsive_control(
            'image_top',
            [
                'label' => esc_html__( 'To Top', 'nutritix' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 100,
    ...
    protected function render() {
        ...
        if ($settings['show_filter_bar'] == 'yes') {
            ...
            <ul class="elementor-galerry__filters"
                ...
                <li class="elementor-galerry__filter elementor-active"
                    data-filter=".masonry-item__all"><?php echo esc_html__('All', 'nutritix'); ?>
        ...
        <div class="elementor-opal-image-gallery">
            <div <?php echo nutritix_elementor_get_render_attribute_string('row', $this) ?>>
                <?php
                ...
                foreach ($image_gallery as $index => $item) {
                    ...
                    <div class="column-item grid__item masonry-item__all <?php echo 'gallery_group_' . esc_attr($item['group']); ?>">
                        <a data-elementor-open-lightbox="yes" <?php echo nutritix_elementor_get_render_attribute_string('link', $this); ?>
...
$widgets_manager->register(new Nutritix_Elementor_Image_Gallery());
