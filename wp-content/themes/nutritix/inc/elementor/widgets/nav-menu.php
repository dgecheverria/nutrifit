...
class Nutritix_Elementor_Nav_Menu extends Elementor\Widget_Base
{
    ...
    {
        return 'nutritix-nav-menu';
    }

    public function get_title()
    {
        return esc_html__('Nutritix Nav Menu', 'nutritix');
    }
    ...
    protected function register_controls()
    {
        ...
        if (!empty($menus)) {
            $this->add_control(
                'menu',
                [
                    'label' => esc_html__('Menu', 'nutritix'),
                    'type' => Controls_Manager::SELECT,
                    'options' => $menus,
                    'default' => array_keys($menus)[0],
                    'save_default' => true,
                    'separator' => 'after',
                    'description' => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'nutritix'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
                ...
                [
                    ...
                    'raw' => '<strong>' . esc_html__('There are no menus in your site.', 'nutritix') . '</strong><br>' . sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'nutritix'), admin_url('nav-menus.php?action=edit&menu=0')),
                    'separator' => 'after',
        ...
        $this->add_group_control(
            ...
            [
                'label' => esc_html__('Typography Menu', 'nutritix'),
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label' => esc_html__('Typography Sub Menu', 'nutritix'),
        ...
        $this->add_control(
            'menu_title_color',
            [
                'label' => esc_html__('Color Menu', 'nutritix'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Sub Menu', 'nutritix'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .main-navigation ul.menu > li.menu-item > a:not(:hover):after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'sub_menu_color',
            [
                'label' => esc_html__('Background Dropdown', 'nutritix'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .main-navigation ul.menu > li.menu-item:hover > a:after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Background Item', 'nutritix'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .main-navigation ul.menu > li.menu-item.current-menu-item > a:not(:hover):after' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .main-navigation ul.menu > li.menu-item.current-menu-parent > a:not(:hover):after' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .main-navigation ul.menu > li.menu-item.current-menu-ancestor > a:not(:hover):after' => 'background-color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        <div <?php echo nutritix_elementor_get_render_attribute_string('wrapper', $this); ?>>
            <nav class="main-navigation" aria-label="<?php esc_attr_e('Primary Navigation', 'nutritix'); ?>">
...
$widgets_manager->register(new Nutritix_Elementor_Nav_Menu());
