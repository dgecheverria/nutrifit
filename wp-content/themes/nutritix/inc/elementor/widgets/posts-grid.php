...
/**
 * Class Nutritix_Elementor_Blog
 */
class Nutritix_Elementor_Post_Grid extends Elementor\Widget_Base {

    public function get_name() {
        return 'nutritix-post-grid';
    }

    public function get_title() {
        return esc_html__('Posts Grid', 'nutritix');
    }
    ...
    public function get_script_depends() {
        return ['nutritix-elementor-posts-grid', 'slick'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => esc_html__('Query', 'nutritix'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'nutritix'),
                    'post_title' => esc_html__('Title', 'nutritix'),
        ...
        $this->add_control(
            'tag_operator',
            [
                'label'     => esc_html__('Tags Operator', 'nutritix'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'IN',
                'options'   => [
                    'AND'    => esc_html__('AND', 'nutritix'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'post-style-1' => esc_html__('Style 1', 'nutritix'),
                    'post-style-2' => esc_html__('Style 2', 'nutritix'),
                ],
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => esc_html__('Pagination', 'nutritix'),
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'options' => [
                    ''                      => esc_html__('None', 'nutritix'),
                    'numbers'               => esc_html__('Numbers', 'nutritix'),
                    'prev_next'             => esc_html__('Previous/Next', 'nutritix'),
                    'numbers_and_prev_next' => esc_html__('Numbers', 'nutritix') . ' + ' . esc_html__('Previous/Next', 'nutritix'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Page Limit', 'nutritix'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Shorten', 'nutritix'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Previous Label', 'nutritix'),
                'default'   => esc_html__('&laquo; Previous', 'nutritix'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Next Label', 'nutritix'),
                'default'   => esc_html__('Next &raquo;', 'nutritix'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . esc_html__('Page', 'nutritix') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" role="navigation"
                 aria-label="<?php esc_attr_e('Pagination', 'nutritix'); ?>">
...
$widgets_manager->register(new Nutritix_Elementor_Post_Grid());
