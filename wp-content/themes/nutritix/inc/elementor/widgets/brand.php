 ...
 * @since 1.0.0
 */
class Nutritix_Elementor_Brand extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Brands', 'nutritix');
    }
    ...
    public function get_script_depends() {
        return ['nutritix-elementor-brand', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => esc_html__('Brands', 'nutritix'),
            ]
        );
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'nutritix'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'nutritix'),
                'placeholder' => esc_html__('Brand Name', 'nutritix'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_responsive_control(
            'brand_source',
            [
                'label'   => esc_html__('Brand Source', 'nutritix'),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'default' => 'image',
                'options' => [
                    'image' => esc_html__('Image', 'nutritix'),
                    'icon'  => esc_html__('Icon', 'nutritix')
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'vh'],
                'selectors' => [
                    '{{WRAPPER}} .elementor-brand-wrapper .column-item' => 'min-height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'style_brand_wrapper',
            [
                'label' => esc_html__('Brand Item', 'nutritix'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .column-item' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .column-item:hover img',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .column-item:hover img, {{WRAPPER}} .column-item:hover i, {{WRAPPER}} .column-item:hover svg' => 'opacity: {{SIZE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .column-item:hover' => 'background-color: {{VALUE}} !important;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .column-item:hover',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .column-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .column-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .column-item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
                        ...
                        <div <?php echo nutritix_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . nutritix_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
...
$widgets_manager->register(new Nutritix_Elementor_Brand());
