...
if (!nutritix_is_woocommerce_activated() || !nutritix_is_dokan_activated()) {
    return;
}
...
class Wpcstore_Elementor_Dokan_Stores extends Elementor\Widget_Base {
    public function get_name() {
        return 'nutritix-dokan-stores';
    }

    public function get_script_depends() {
        return ['nutritix-elementor-dokan-store', 'slick'];
    }

    public function get_title() {
        return esc_html__('Nutritix Dokan Stores', 'nutritix');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'limit',
            [
                'label'   => esc_html__('Stores Per Page', 'nutritix'),
        ...
        $this->add_control(
            'featured',
            [
                'label' => __('Stores featured', 'nutritix'),
        ...
        $this->add_control(
            'with_products_only',
            [
                'label' => __('Stores with products only', 'nutritix'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'store_id',
            [
                'label'       => __('Include', 'nutritix'),
                'type'        => Controls_Manager::TEXT,
                'description' => esc_html__('Include vendor by id separated by "," for example: (1,2,3)', 'nutritix')
            ]
        );
        ...
        ?>>
            ...
            ?>>
                <?php if ($sellers['users']) { ?>
                        ...
                        <div class="dokan-single-seller column-item">
                            <?php if ($settings['style'] == 'style-3'): ?>
                                <div class="product-wrapper">
                                    ...
                                    if ($products->have_posts()) {
                                        ...
                                        esc_html_e('No product has been found!', 'nutritix');
                                    }
                            ...
                            <div class="store-wrapper">
                                ...
                                <div class="store-data">
                                    ...
                                    <div class="product-count"><?php echo sprintf(_n('%d Product', '%d Products', $products_count->publish, 'nutritix'), $products_count->publish); ?></div>
                                    <?php if (!empty($store_rating['count'])): ?>
                                        <div class="dokan-seller-rating" title="<?php echo sprintf(esc_attr__('Rated %s out of 5', 'nutritix'), esc_attr($store_rating['rating'])) ?>">
                    ...
                    <div class="dokan-error"><?php esc_html_e('No vendor found!', 'nutritix'); ?></div>
                <?php } ?>
            </div>
        </div>
        <?php
