...
class Nutritix_Elementor_Vertiacl_Menu extends Elementor\Widget_Base
{
    ...
    {
        return 'nutritix-vertical-menu';
    }

    public function get_title()
    {
        return esc_html__('Nutritix Vertical Menu', 'nutritix');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'nav_vertiacl_layout',
            [
                'label' => esc_html__('Menu Layout', 'nutritix'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'style-1' => esc_html__('Layout 1', 'nutritix'),
                    'style-2' => esc_html__('Layout 2', 'nutritix'),
                ],
                'default' => 'style-1',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation .vertical-navigation-header .nutritix-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Icon Hover', 'nutritix'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
                    ...
                    '{{WRAPPER}} .vertical-navigation:hover .vertical-navigation-header .nutritix-icon' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sub Menu', 'nutritix'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Active', 'nutritix'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Color Hover', 'nutritix'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render()
    {
        ...
        <div <?php echo nutritix_elementor_get_render_attribute_string('wrapper', $this); ?>>
            <nav class="vertical-navigation" aria-label="<?php esc_attr_e('Vertiacl Navigation', 'nutritix'); ?>">
...
$widgets_manager->register(new Nutritix_Elementor_Vertiacl_Menu());
