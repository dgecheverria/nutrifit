...
if (!nutritix_is_mailchimp_activated()) {
    return;
}
...
class Nutritix_Elementor_Mailchimp extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'nutritix-mailchmip';
    }

    public function get_title()
    {
        return esc_html__('MailChimp Sign-Up Form', 'nutritix');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Input', 'nutritix'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Color Placeholder', 'nutritix'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab(
            'tab_input_focus',
            [
                'label' => esc_html__('Focus', 'nutritix'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Border Color hover', 'nutritix'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Nutritix_Elementor_Mailchimp());
