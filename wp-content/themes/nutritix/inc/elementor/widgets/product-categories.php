...
/**
 * Elementor Nutritix_Elementor_Products_Categories
 * @since 1.0.0
 */
class Nutritix_Elementor_Products_Categories extends Elementor\Widget_Base
{
    ...
    {
        return 'nutritix-product-categories';
    }
    ...
    {
        return esc_html__('Product Categories', 'nutritix');
    }
    ...
    {
        return ['nutritix-elementor-product-categories', 'slick'];
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            'categories_name',
            [
                'label' => esc_html__('Alternate Name', 'nutritix'),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => 'cate_image',
                'options' => [
                    'cate_image' => esc_html__('Image', 'nutritix'),
                    'cate_icon' => esc_html__('Icon', 'nutritix'),
                ]
            ]
        );
        ...
        $repeater->add_control(
            'tab_color_item',
            [
                'label' => __('Background Color', 'nutritix'),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    '3' => esc_html__('Layout 3', 'nutritix'),
                ]
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .nutritix-carousel .column-item' => 'padding-left: calc({{SIZE}}{{UNIT}} / 2); padding-right: calc({{SIZE}}{{UNIT}} / 2);',
        ...
        $this->start_controls_section(
            'caption_style',
            [
                'label' => esc_html__('Caption', 'nutritix'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            'image_max_width',
            [
                'label' => esc_html__('Max Width', 'nutritix'),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'unit' => '%',
                ],
        ...
        $this->start_controls_section(
            'total_style',
            [
                'label' => esc_html__('Total', 'nutritix'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'total_color_text',
            [
                'label' => esc_html__('Color Text', 'nutritix'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'total_color_hover',
            [
                'label' => esc_html__('Color Count', 'nutritix'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Background Color Hover', 'nutritix'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
                    ...
                    <?php foreach ($settings['categories_list'] as $index => $item): ?>
                        ...
                        <div <?php echo nutritix_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <?php if (empty($item['categories'])) {
                                echo esc_html__('Choose Category', 'nutritix');
                                return;
                            }
                                            ...
                                            <div class="product-cat-caption">
                                                ...
                                                <div class="cat-total">
                                                    <span class="count">
                                                        ...
                                                        <?php echo esc_html__('Products', 'nutritix'); ?>
                                                    </span>
                                                </div>
                                            </div>
                                        <?php endif; ?>
...
$widgets_manager->register(new Nutritix_Elementor_Products_Categories());
