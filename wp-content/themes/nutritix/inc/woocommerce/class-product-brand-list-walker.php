<?php
/**
 * Nutritix_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Nutritix_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Nutritix_Product_Brand_List_Walker', false)) :

	class Nutritix_Product_Brand_List_Walker extends Walker {
