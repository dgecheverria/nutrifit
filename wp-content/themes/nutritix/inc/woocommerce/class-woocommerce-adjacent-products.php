<?php
/**
 * Nutritix WooCommerce Adjacent Products Class
 *
 * @package  nutritix
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Nutritix_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Nutritix WooCommerce Adjacent Products Class
	 */
	class Nutritix_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'nutritix_woocommerce_adjacent_query_args', $args ) );
